...
public class ReservasTest {
	...
	private static final String NOMBRE_PROFESOR1 = "Jos茅 Ram贸n";
	private static final String NOMBRE_PROFESOR2 = "Andr茅s";
	...
	public void insertarReservaDiferentePermanenciaTest() {
		...
		try {
			...
			assertEquals("Ya se ha realizado una reserva por hora para este d韆 y aula.", e.getMessage());
			assertEquals(1, reservas.getNumReservas());
		} 
		...
		try {
			...
			assertEquals("Ya se ha realizado una reserva por tramo para este d韆 y aula.", e.getMessage());
			assertEquals(1, reservas.getNumReservas());
		} 
	}
	...
	public void insertarReservaMesActualTest() {
		...
		try {
			...
			assertEquals("S髄o se pueden hacer reservas para el mes que viene o posteriores.", e.getMessage());
			assertEquals(0, reservas.getNumReservas());
		} 
	}
	...
	public void insertarPuntosSobrepasadosTest() {
		...
		try {
			...
			assertEquals("Esta reserva excede los puntos m醲imos por mes para dicho profesor.", e.getMessage());
